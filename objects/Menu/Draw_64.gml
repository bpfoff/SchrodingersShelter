...
if(room == menu_howToPlayMenu){
	...
	draw_text_ext(x, y, "HOW TO PLAY\n\nThe objective of this game is to adopt as many cats as possible out to the owners that will love them the most before time runs out.\n\n1. Cats will come and line up in the shelter. Once they are in line you can click on them to open their options menu. If you select the traits option you can see information about each cat, including its characteristics. If you select the move option you can pick up and move the cat into one of the four shelter rooms.\n2. People will line up in the shelter. You can click on them to view their menu and if you select the traits option you can see information about them including what characteristics they are looking for in their perfect cat.\n4. Adopt a cat out to a person by moving them to that person. The more characteristics you match, the higher the score you'll get! In level 1 you only need to match one characteristic to get the maximum score. In level 2 you need to match two characteristics, and in level 3 you need to match three characteristics.\n5. Careful! A cat cannot be moved from a shelter room unless it is getting adopted.\n6. CW for flashing lights in the collar menus, press ESC to pause, Good Luck!" ,40, window_get_width() - x*2);
